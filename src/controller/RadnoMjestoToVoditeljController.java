			...
			try {
				...
				while (rs.next()) {
					...
					try {
						...
						stmt1.setString(1, idZaposlenik);
						
						ResultSet rs1 = stmt1.executeQuery();
						while(rs1.next())
						brojZaposlenih = rs1.getString(1);
						rs1.close();
					} catch (SQLException e) {
						System.out.println(e);
					}
		
					radnoMjestoToVoditeljList.add(rs.getString(1) + " " + rs.getString(2) + ", " + rs.getString(3) + ", " + brojZaposlenih);
				}
